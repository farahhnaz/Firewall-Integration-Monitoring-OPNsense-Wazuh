...
![GeoIP Firewall Rule](screenshots/02-geoip-firewall-rule.png.png)

**Validation**

![GeoIP Blocking Validation](screenshots/03-geoip-blocking-validation.png.png)
...
![DNS Blocking Validation](screenshots/04-dns-blocking-validation.png.png)
...
![Administrator Access Validation](screenshots/05-admin-access-control-validation.png.png)

**Non-Administrator Validation**

![Non-Administrator Access Validation](screenshots/06-nonadmin-access-control-validation.png.png)
...
![Custom Wazuh Rule and Validation](screenshots/07-custom-wazuh-rule-110005.png.png)
...
![Wazuh Dashboard Visualization](screenshots/08-wazuh-dashboard-visualization.png.png)
...
The repository includes screenshots demonstrating the implementation and validation of the project:

- OPNsense Dashboard
- GeoIP Firewall Rule Configuration
- GeoIP Blocking Validation
- DNS-Based Website Blocking Validation
- Administrator Access Validation
- Non-Administrator Access Validation
- Custom Wazuh Rule (Rule ID 110005)
